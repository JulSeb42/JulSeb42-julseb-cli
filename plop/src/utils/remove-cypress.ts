...
export function removeCypress(projectName: string, boilerplate: string) {
    const actions: Array<ExtendedActionTypes> = [
        "Removing Cypress",
        {
            type: "runCommand",
        ...
        "Add new plop generator for component",
        {
            ...
            templateFile:
                `../templates/${boilerplate}/plop-component-no-tests.hbs`,
        },
