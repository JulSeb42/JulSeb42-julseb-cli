...
const { jwtConfig, SALT_ROUNDS, TOKEN_SECRET, sendMail } = require("../utils")
const { COMMON_TEXTS, SERVER_PATHS } = require("../../shared")
        ...
        .then(async foundUser => {
            ...
            return await UserModel.create({
                ...
                sendMail(
                    ...
                    COMMON_TEXTS.EMAIL_SIGNUP_BODY(createdUser, verifyToken)
                )
